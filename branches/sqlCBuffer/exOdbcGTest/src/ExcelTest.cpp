...
namespace exodbc
{
	...
	TEST_F(ExcelTest, SelectManualWCharValues)
	{
		...
		SQLWCHAR tc[512];
		SQLWCHAR mx[512];
		ASSERT_NO_THROW(tTable.SetColumn(0, L"ID", SQL_VARCHAR, id, SQL_C_WCHAR, sizeof(id), OldColumnFlag::CF_SELECT));
		ASSERT_NO_THROW(tTable.SetColumn(1, L"Int", SQL_VARCHAR, ic, SQL_C_WCHAR, sizeof(id), OldColumnFlag::CF_SELECT));
		ASSERT_NO_THROW(tTable.SetColumn(2, L"Float", SQL_VARCHAR, fc, SQL_C_WCHAR, sizeof(id), OldColumnFlag::CF_SELECT));
		ASSERT_NO_THROW(tTable.SetColumn(3, L"Text", SQL_VARCHAR, tc, SQL_C_WCHAR, sizeof(id), OldColumnFlag::CF_SELECT));
