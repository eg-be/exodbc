...
void printHelp()
{
	...
	WRITE_STDOUT_ENDL("");
	WRITE_STDOUT_ENDL("If DATABASE is specified, you can either supply a connection-string or a DSN-entry");
	WRITE_STDOUT_ENDL("to indicate the connection info of the test database:");
	WRITE_STDOUT_ENDL(" To connect using a configured DSN entry use:");
	WRITE_STDOUT_ENDL("");
	WRITE_STDOUT_ENDL("  DSN=dsn;user;pass (to connect to a database with UPPER-case names (tables/columns))");
	WRITE_STDOUT_ENDL("  dsn=dsn;user;pass (to connect to a database with lower-case names (tables/columns))");
	WRITE_STDOUT_ENDL("");
	WRITE_STDOUT_ENDL(" or to connect using a connection-string use:");
	WRITE_STDOUT_ENDL("");
	WRITE_STDOUT_ENDL("  CS=connectionString (to connect to a database with UPPER-case names (tables/columns))");
	WRITE_STDOUT_ENDL("  cs=connectionString (to connect to a database with lower-case names (tables/columns))");
	WRITE_STDOUT_ENDL("");
	...
	WRITE_STDOUT_ENDL(" --createDb       Run the scripts to create the test database before running the tests.");
	WRITE_STDOUT_ENDL("                    The TestDbCreator will connect to the database and try to detect");
	WRITE_STDOUT_ENDL("                    the database system. If there is a subdirectory matching the");
	WRITE_STDOUT_ENDL("                    database system name in 'CreateScripts' directory, all scripts");
	WRITE_STDOUT_ENDL("                    inside that directory are run.");
	...
	WRITE_STDOUT_ENDL(" --logFile        Log additionally to a file 'exODbcGTest.log' in the current directory");
