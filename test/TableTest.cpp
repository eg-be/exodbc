...
#else
			EXPECT_EQ(255, pBlob16->GetBufferLength());
			EXPECT_EQ(255, pVarblob20->GetBufferLength());
			EXPECT_EQ(255, pBlob16->GetNrOfElements());
			EXPECT_EQ(255, pVarblob20->GetNrOfElements());
#endif
		}
		else
		{
