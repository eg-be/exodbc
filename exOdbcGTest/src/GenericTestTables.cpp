...
namespace exodbc
{
	...
	CharTypesTable::CharTypesTable(Database* pDb)
		: Table(pDb, 3, L"chartypes", L"", L"", L"", Table::READ_ONLY)
	{
		m_idCharTypes	= 0;
		m_varchar[0]	= 0;
		m_char[0]		= 0;
	...
	CharTypesTmpTable::CharTypesTmpTable(Database* pDb)
		: Table(pDb, 3, L"chartypes_tmp", L"", L"", L"", Table::READ_ONLY)
	{
		m_idCharTypes	= 0;
		m_varchar[0]	= 0;
		m_char[0]		= 0;
	...
	IntTypesTmpTable::IntTypesTmpTable(Database* pDb)
		: Table(pDb, 4, L"integertypes_tmp", L"", L"", L"", Table::READ_ONLY)
	{	
		m_idIntegerTypes = 0;
		m_smallInt = 0;
		m_int = 0;
	...
	DateTypesTable::DateTypesTable(Database* pDb)
		: Table(pDb, 4, L"datetypes", L"", L"", L"", Table::READ_ONLY)
	{
		m_idDateTypes		= 0;
	...
	DateTypesTmpTable::DateTypesTmpTable(Database* pDb)
		: Table(pDb, 4, L"datetypes_tmp", L"", L"", L"", Table::READ_ONLY)
	{
		m_idDateTypes		= 0;
		ZeroMemory(&m_date, sizeof(m_date));
		ZeroMemory(&m_time, sizeof(m_time));
	...
	FloatTypesTable::FloatTypesTable(Database* pDb)
		: Table(pDb, 3, L"floattypes", L"", L"", L"", Table::READ_ONLY)
	{
		m_idFloatTypes	= 0;
		m_double		= 0;
		m_float			= 0;
	...
	FloatTypesTmpTable::FloatTypesTmpTable(Database* pDb)
		: Table(pDb, 3, L"floattypes_tmp", L"", L"", L"", Table::READ_ONLY)
	{
		m_idFloatTypes	= 0;
		m_double		= 0;
		m_float			= 0;
	...
	NumericTypesTable::NumericTypesTable(Database* pDb, ReadMode readMode)
		: Table(pDb, 3, L"numerictypes", L"", L"", L"", Table::READ_ONLY)
		, m_readMode(readMode)
	{
		m_idNumericTypes	= 0;
	...
	NumericTypesTmpTable::NumericTypesTmpTable(Database* pDb, ReadMode readMode)
		: Table(pDb, 3, L"numerictypes_tmp", L"", L"", L"", Table::READ_ONLY)
		, m_readMode(readMode)
	{
		m_idNumericTypes	= 0;
		ZeroMemory(&m_decimal_18_0, sizeof(m_decimal_18_0));
	...
	BlobTypesTable::BlobTypesTable(Database* pDb)
		: Table(pDb, 2, L"blobtypes", L"", L"", L"", Table::READ_ONLY)
	{
	...
	BlobTypesTmpTable::BlobTypesTmpTable(Database* pDb)
		: Table(pDb, 2, L"blobtypes_tmp", L"", L"", L"", Table::READ_ONLY)
	{
		ZeroMemory(m_blob, sizeof(m_blob));
	...
	CharTable::CharTable(Database* pDb)
		: Table(pDb, 4, L"chartable", L"", L"", L"", Table::READ_ONLY)
	{
		m_idCharTable	= 0;
		m_col2[0] = 0;
		m_col3[0] = 0;
