...
namespace exodbc
{
	...
	public:
		...
		MIntTypesTable(const Database& db, test::Case namesCase = test::Case::LOWER, const std::wstring& name = L"IntegerTypes");
	...
	{
	public:
		MFloatTypesTable(const Database& db, test::Case namesCase = test::Case::LOWER, const std::wstring& name = L"FloatTypes");
	...
	public:
		...
		MCharTypesTable(const Database& db, test::Case namesCase = test::Case::LOWER, const std::wstring& name = L"CharTypes");
	...
	public:
		...
		MWCharTypesTable(const Database& db, test::Case namesCase = test::Case::LOWER, const std::wstring& name = L"CharTypes");
	...
	{
	public:
		MDateTypesTable(const Database& db, test::Case namesCase = test::Case::LOWER, const std::wstring& name = L"DateTypes");
	...
	{
	public:
		MBlobTypesTable(const Database& db, test::Case namesCase = test::Case::LOWER, const std::wstring& name = L"BlobTypes");
	...
	{
	public:
		MNumericTypesTable(const Database& db, test::Case namesCase = test::Case::LOWER, const std::wstring& name = L"NumericTypes");
	...
	{
	public:
		MNumericTypesAsCharTable(const Database& db, test::Case namesCase = test::Case::LOWER, const std::wstring& name = L"NumericTypes");
	...
	{
	public:
		MCharTable(const Database& db, test::Case namesCase = test::Case::LOWER);
		virtual ~MCharTable() {};
	...
	{
	public:
		MIncompleteCharTable(const Database& db, test::Case namesCase = test::Case::LOWER);
	...
	{
	public:
		MNotExistingTable(const Database& db, test::Case namesCase = test::Case::LOWER);
		~MNotExistingTable() {};
